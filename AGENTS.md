...
## Source of Truth
- Product source-of-truth for requirements lives in `docs/requirements.md` 
- For any design or implementation task in this project, read the requirement file first.
- Do not modify `docs/requirements.md` in the repository. Requirement updates are user-owned.
